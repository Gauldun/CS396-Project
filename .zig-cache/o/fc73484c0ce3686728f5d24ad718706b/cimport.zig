...
pub const PlayerEntityHandle = anyopaque;
pub const EnemyEntityHandle = anyopaque;
pub const ItemHandle = anyopaque;
pub extern fn PlayerEntityCreate(hVal: i32, dVal: i32, rVal: i32, sVal: i32) ?*PlayerEntityHandle;
pub extern fn EnemyEntityCreate(hVal: i32, dVal: i32, rVal: i32, sVal: i32) ?*EnemyEntityHandle;
pub extern fn ItemHandleCreate(dmgBool: bool, suppBool: bool, effectBool: bool, durVal: i32) ?*ItemHandle;
pub extern fn PlayerEntityDestroy(handle: ?*PlayerEntityHandle) void;
pub extern fn EnemyEntityDestroy(handle: ?*EnemyEntityHandle) void;
pub extern fn ItemDestroy(handle: ?*ItemHandle) void;
pub extern fn PlayerEntityEquipItem(handle: ?*PlayerEntityHandle, modifiedVal: i32, newItemMod: i32, oldItemMod: i32) i32;
pub extern fn PlayerEntityGetHealth(handle: ?*PlayerEntityHandle) i32;
pub extern fn PlayerEntityGetDamage(handle: ?*PlayerEntityHandle) i32;
pub extern fn PlayerEntityGetRange(handle: ?*PlayerEntityHandle) i32;
pub extern fn PlayerEntityGetSpeed(handle: ?*PlayerEntityHandle) i32;
pub extern fn EnemyEntityGetHealth(handle: ?*EnemyEntityHandle) i32;
pub extern fn EnemyEntityGetDamage(handle: ?*EnemyEntityHandle) i32;
pub extern fn EnemyEntityGetRange(handle: ?*EnemyEntityHandle) i32;
pub extern fn EnemyEntityGetSpeed(handle: ?*EnemyEntityHandle) i32;
pub extern fn ItemGetDuration(handle: ?*ItemHandle) i32;
pub extern fn PlayerEntitySetHealth(handle: ?*PlayerEntityHandle, newHealth: i32) void;
pub extern fn PlayerEntitySetDamage(handle: ?*PlayerEntityHandle, newDamage: i32) void;
pub extern fn PlayerEntitySetRange(handle: ?*PlayerEntityHandle, newRange: i32) void;
pub extern fn PlayerEntitySetSpeed(handle: ?*PlayerEntityHandle, newSpeed: i32) void;
pub extern fn EnemyEntitySetHealth(handle: ?*EnemyEntityHandle, newHealth: i32) void;
pub extern fn EnemyEntitySetDamage(handle: ?*EnemyEntityHandle, newDamage: i32) void;
pub extern fn EnemyEntitySetRange(handle: ?*EnemyEntityHandle, newRange: i32) void;
pub extern fn EnemyEntitySetSpeed(handle: ?*EnemyEntityHandle, newSpeed: i32) void;
pub extern fn ItemSetDuration(handle: ?*ItemHandle, newDur: i32) void;
...
pub const _LIBCPP_HAS_TIME_ZONE_DATABASE = @as(c_int, 1);
...
// (no file):458:9
pub const _LIBCPP_ENABLE_CXX17_REMOVED_UNEXPECTED_FUNCTIONS = @as(c_int, 1);
...
// /usr/lib/zig/libcxx/include/__configuration/abi.h:154:9
